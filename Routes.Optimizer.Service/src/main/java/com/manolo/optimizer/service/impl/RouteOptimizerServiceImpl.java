...
public class RouteOptimizerServiceImpl implements  RouteOptimizerService {
    ...
    public GetOptimizedRouteResponse getOptimizedRoutes(GetOptimizedRouteRequest request) throws RouteOptimizerServiceException {
        ...
        Collection<RouteNode> routeNodes = queryRoutes(loadBalancerUrl);
     ...
     */
    private Collection<RouteNode> queryRoutes(String loadBalancerUrl) throws RouteOptimizerServiceException {
        ...
        try {
        	entity = template.exchange( url, HttpMethod.GET , request , String.class); // could throw RestClientException
